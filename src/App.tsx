...
const apps = [
  ...
  { name: 'BUCKS Currency PRO++', rating: 4.9, icon: 'https://cdn.shopify.com/app-store/listing_images/711119d0bf4a6aaa500abe82a4c593af/icon/CIbBrK6-4pIDEAE=.png', url: 'https://apps.shopify.com/partners/helixo-co' },
  { name: 'Wowcart Slide Cart', rating: 5.0, icon: 'https://cdn.shopify.com/app-store/listing_images/2a82d14ff0908b4b11a67b003ee37313/icon/CK-H2dz2tPsCEAE=.jpeg', url: 'https://apps.shopify.com/partners/helixo-co' },
  ...
  { name: 'HUE Free Gifts', rating: 4.5, icon: 'https://cdn.shopify.com/app-store/listing_images/3e809f875c8c7f4975e920b662d791aa/icon/CPzrxdeCnZMDEAE=.png', url: 'https://apps.shopify.com/partners/helixo-co' },
  { name: 'ShopSTR Bookings', rating: 4.9, icon: 'https://cdn.shopify.com/app-store/listing_images/65185eb83d87cabb6b113181e4878679/icon/CI2T8N3Q4oADEAE=.png', url: 'https://apps.shopify.com/shopbnb' },
]
